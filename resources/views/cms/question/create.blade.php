                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div id="zero_config_wrapper" class="dataTables_wrapper dt-bootstrap4">
                            <div class="card">
                                <form class="form-horizontal" action="{{route('cms.question.store', ['id' => $khoaId])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <fieldset id="group2" style="position: relative; top: 8px">
                                                            <input type="checkbox" value="a" name="da[]"> A &nbsp;&nbsp;&nbsp;
                                                            <input type="checkbox" value="b" name="da[]"> B &nbsp;&nbsp;&nbsp;
                                                            <input type="checkbox" value="c" name="da[]"> C &nbsp;&nbsp;&nbsp;
                                                            <input type="checkbox" value="d" name="da[]"> D &nbsp;&nbsp;&nbsp;
                                                        </fieldset>
                                                    </div>
                                                </div>
                                            </div>
